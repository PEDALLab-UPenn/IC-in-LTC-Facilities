...
log using "$log/Table2_communitydwelling.log", replace
...
save `2016biennial'
*2. Read Rand HRS Longitudinal File 2016 and subset to only include wave13
...
distinct hhidpn
*** Save as a tempfile
tempfile communitydwelling
save `communitydwelling'
...
tab Informal,m
*4. Keep if Informal equals to 1 AND keep unique IDs for merging
keep if Informal == 1
...
tempfile helper
save `helper'
*6. Merge with the Community
use `communitydwelling',clear
...
preserve
keep if walkdiff ==1
tablist walkdiffinformal Informal, sort(v)
tab walkdiffinformal, m
tab walkdiffinformal[aweight=r13wtrespe], m
restore
